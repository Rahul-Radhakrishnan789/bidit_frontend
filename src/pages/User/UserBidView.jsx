                ...
                <Gridcontainer container spacing={{xs:5, lg:2}} >
                    <GridItems item xs={12} lg={6}>
                        <FirstItem>
                            <BidCard>
                                <TimeLeft
                                    sx={{ flexDirection: { xs: "column", md: "row" }, gap: { xs: "1rem", md: "4rem" } }}
                                >
                                    <Box className="left">
                                    ...
                                    <Box className="right">
                                        ...
                                        <span id="ending">Ending tomorrow at 9:30:00 PM</span>
                                    </Box>
                                </TimeLeft>
                                <CurretBid
                                
                                >
                                    <Box className="bid_details"
                                    sx={{ flexDirection: { xs: "column", md: "row" }, gap: { xs: "1rem", md: "3rem" } }}>
                                        <Box className="left">
                              ...
                              <Box className='bid_history'><Typography>BID HISTORY</Typography><span>60 bids, 7bidders</span></Box>
                        ...
                        <SecondItem >
                           <Gridcontainer container spacing={2}>
                            <GridItems item xs={12} sm={6}>
                                <Box>
                                    <img style={{height:'100%', width:'100%' ,borderRadius:'20px'}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFx_imqgFIWP8lUUkSPxIx7rnS9rf5cqtfI8KFvGihOQ&s" alt="" />
                                </Box>
                            </GridItems>
                            <GridItems item xs={12} sm={6}>
                                <Box>
